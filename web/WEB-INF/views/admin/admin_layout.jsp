...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/admin_dashboard_styles.css"> <%-- Adjust path as needed --%>
...
<body>
    ...
    <script src="${pageContext.request.contextPath}/admin/dashboard_data.js"></script> <%-- Adjust path as needed --%>
